...
\end{tabular}\par
\end{minipage}\par\vspace{2.4mm}
\par\noindent\begin{minipage}{\linewidth}
\textbf{2.} Digues si cada afirmació és certa o falsa, i justifica-ho breument:\par

\begin{itemize}[leftmargin=0pt,itemsep=6pt,topsep=5pt,parsep=0pt,label={}]
...
\end{minipage}\par\vspace{2.4mm}
\par\noindent\begin{minipage}{\linewidth}
\textbf{13.} Resol $|2x-6|<10$. \emph{(Pista: pots treure factor comú $2$ dins el valor absolut abans d'aïllar.)}\par
\end{minipage}\par\vspace{2.4mm}
\par\noindent\begin{minipage}{\linewidth}
...
\end{minipage}\par\vspace{2.4mm}
\par\noindent\begin{minipage}{\linewidth}
\textbf{96.} Demostra que $\log_{a^2} x = \dfrac12 \log_a x$. \emph{(Pista: aplica el canvi de base a la base $a$.)}\par
\end{minipage}\par\vspace{2.4mm}
